...
from hai_mr05 import controller
...
class ControllerRuntimeTests(unittest.TestCase):
    ...
    def test_external_boundary_counters_are_zero(self):
        ...
        for n in ("STATE_TRANSITION_EXECUTION_COUNT","HUMAN_APPROVAL_EXECUTION_COUNT","HUMAN_GATE_EXECUTION_COUNT","MR03_EXECUTION_IMPLEMENTATION_COUNT","MR04_EXECUTION_IMPLEMENTATION_COUNT","FILESYSTEM_WRITE_IMPLEMENTATION_COUNT","SUBPROCESS_EXECUTION_COUNT","NETWORK_IMPLEMENTATION_COUNT","PROVIDER_CLIENT_IMPLEMENTATION_COUNT","MODEL_CALL_IMPLEMENTATION_COUNT","MODEL_ROUTING_IMPLEMENTATION_COUNT","AUTH_IMPLEMENTATION_COUNT","AUTO_RETRY_IMPLEMENTATION_COUNT","AUTO_FALLBACK_IMPLEMENTATION_COUNT","EVIDENCE_PERSISTENCE_COUNT"): self.assertEqual(getattr(controller,n),0,n)
